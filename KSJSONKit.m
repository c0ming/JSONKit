...
static NSString *const NSJSONKitErrorDomain = @"me.c0ming.KSJSONKit";

@implementation NSObject (KSJSONKit)
...
@implementation NSString (KSJSONKit)
...
@implementation NSData (KSJSONKit)
